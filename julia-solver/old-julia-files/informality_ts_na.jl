...
# Load the Excel file
xlsx = XLSX.readxlsx("C:/Users/nicol/Documents/GitHub/Research/H-drive-umn/julia-solver/time_series_na.xlsx")
...
for row in eachrow(df)
    ...
    K           = row.capital_na*1e6
    No          = row.employment_na_info *1e3
    Nf          = row.employment_na*1e3 - No 
    alpha       = row.beta_k 
    gamma_f     = row.beta_n
...
output_path = "C:/Users/nicol/Documents/GitHub/Research/H-drive-umn/julia-solver/informality_series_na.xlsx"
    ...
    for country in unique(df.country)
        ...
        if length(idxs) == 1
            ...
            for i in (start_idx - 1):-1:1
                ...
                K           = subdf.capital_na[i + 1]*1e6
                No          = subdf.employment_na_info[i + 1]*1e3
                Nf          = subdf.employment_na[i + 1]*1e3 - No 
                K_prev      = subdf.capital_na[i]*1e6
                No_prev     = subdf.employment_na_info[i]*1e3
                Nf_prev     = subdf.employment_na[i]*1e3 - No_prev 
...
figpath = "C:/Users/nicol/Documents/GitHub/Research/H-drive-umn/julia-solver/Charts/"
